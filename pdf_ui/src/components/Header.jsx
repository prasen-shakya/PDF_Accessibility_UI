...
function Header({
  ...
  const usagePercentage =
    maxFilesAllowed > 0
      ? Math.min((usageCount / maxFilesAllowed) * 100, 100)
      : 0;
            ...
            >
              ...
              >
                {loadingUsage
                  ...
                  : usageError
                  ? "Error"
                  : `${formatNumber(usageCount)}/${formatNumber(
                      maxFilesAllowed
                    )}`}
              </Typography>
              <IconButton
                ...
                aria-label={
                  usageExpanded ? "Hide usage details" : "Show usage details"
                }
                sx={{
                  color: "inherit",
                  p: 0.25,
            ...
            >
              ...
              >
                {loadingUsage
                  ...
                  : usageError
                  ? `Error: ${usageError}`
                  : `Used: ${formatNumber(usageCount)} / ${formatNumber(
                      maxFilesAllowed
                    )}`}
              </Typography>
